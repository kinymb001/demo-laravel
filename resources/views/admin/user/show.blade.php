...
@section('body')
    <div class="content-wrapper">
        <x-breadcrumb name="User {{ $data->name }}" />
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-2">
                                        ...
                                        <div class="col-12">
                                            <img src="
                                        @if ($data->avatar) {{ asset('assets/images/users/' . $data->avatar) }}
                                        @else
                                            {{ asset('assets/images/users/avatar.png') }} @endif
                                    "
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <p>Đăng xuất lúc: {{ $data->logout_at }}</p>
                                        <p>Số lần đăng nhập thất bại : {{ $data->password_failed }}</p>
                                        <p>Tạo lúc: {{ $data->created_at }}</p>

                                        <hr>
                                        <h4>Số bài viết đã đăng: {{ $data->articles->count() }}</h4>
                                        <div>
                                            <a class="btn btn-warning" href="{{ route('users.edit', $data->id) }}"
                                                data-tippy-content="{{ __('messages.edit') }}">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('users.destroy', $data->id) }}" class="d-inline delete"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="tab-content p-3" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="product-rating" role="tabpanel"
                                            ...
                                            ullamcorper. Donec varius massa at semper posuere. Integer finibus orci vitae

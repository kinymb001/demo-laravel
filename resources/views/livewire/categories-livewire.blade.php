<div class="card-body">
    <div class="flex flex-between">
        <div>
            <a href="{{ route('categories.create') }}" class="btn btn-outline-primary" type="button"
                data-tippy-content="{{ __('messages.categories.add') }}">
            ...
            @endcan
            <a href="{{ route('exportCategories') }}" class="btn btn-outline-success" type="button" id="excel"
    ...
    <div class="table-responsive">
                        ...
                        <tr wire:key="item-{{ $value->id }}">
                            ...
                            <td>
                                <div class="text-center">
                                    @can('role-create')
                                        <a class="btn btn-success" href="{{ route('categories.show', $value->id) }}"
                                            data-tippy-content="{{ __('messages.detail') }}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                    @endcan
                                    @can('role-edit')
                                        <a class="btn btn-warning" href="{{ route('categories.edit', $value->id) }}"
        ...
        <x-modal_confirm />
        <x-modal_reset_confirm url="{{ route('resetCategories') }}" />
